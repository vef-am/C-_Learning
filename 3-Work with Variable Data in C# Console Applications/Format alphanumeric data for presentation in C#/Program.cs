...
string newProduct = "Glorius Future";
...
message += $"Currently, you own {currentShares:N2} shares at a return of {currentReturn:P2}.\n\n";
message += $"Our new product, {newProduct} offers a return of {newReturn:P2}. Given your current volume, your potential profit would be {newProfit:C2}\n";
