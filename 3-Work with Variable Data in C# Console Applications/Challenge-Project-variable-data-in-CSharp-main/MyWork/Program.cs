...
// Because my PC uses comma instead of period
...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            string[] dogCharacteristics = dogCharacteristic.Trim(' ').Split(',');
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 1].Contains("dog"))
                {
                    ...
                    foreach (var charac in dogCharacteristics)
                    {
                        for (int j = 5; j > -1; j--)
                        {
                            ...
                            {
                                Console.Write($"\rsearching our dog {ourAnimals[i, 3]} for {charac} {icon}");
                                Thread.Sleep(250);
                            }
                        ...
                        if (dogDescription.Contains(charac))
                        {
                            // #3b update message to reflect term 
                            // #3c set a flag "this dog" is a match
                            Console.WriteLine($"Our dog {ourAnimals[i, 3]} matches your search for {charac}");
                            isAMatch = true;
