...
{
    int restTwenties = cashTill[3] + twenties;
    int restTens = cashTill[2] + tens;
    int restFives = cashTill[1] + fives;
    int restOnes = cashTill[0] + ones;
    ...
    while ((changeNeeded > 19) && (restTwenties > 0))
    {
        restTwenties--;
        changeNeeded -= 20;
    ...
    while ((changeNeeded > 9) && (restTens > 0))
    {
        restTens--;
        changeNeeded -= 10;
    ...
    while ((changeNeeded > 4) && (restFives > 0))
    {
        restFives--;
        changeNeeded -= 5;
    ...
    while ((changeNeeded > 0) && (restOnes > 0))
    {
        restOnes--;
        changeNeeded -= 1;
    ...
    cashTill[3] = restTwenties;
    cashTill[2] = restTens;
    cashTill[1] = restFives;
    cashTill[0] = restOnes;
}
